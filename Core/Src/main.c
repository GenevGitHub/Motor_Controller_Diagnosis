...
uint8_t counter;
uint32_t adc_dma_buffer[ADC_CHANNEL_MAX];
uint32_t adc_value[ADC_CHANNEL_MAX];
float analog_value[ADC_CHANNEL_MAX];
float R1 = 143000;
float R2 = 8060;

//count the number of errors for reading the HALL SENSORS
uint8_t error = 0x00;

//Global Variables for Controlling HALL SENSORS
//Global Variable
